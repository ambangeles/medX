...
class Fprint extends React.Component {
  ...
  componentDidMount() {
    ...
    const { records, medHis } = this.props.medrec;
    this.setState({
    ...
    this.setState({
      ...
      sex: patient.sex,
      age: patient.age,
      birthdate: `${patient.birthMonth} ${patient.birthDay}, ${patient.birthYear}`,
    ...
    if (medHis !== null) {
      this.setState({
        isHistory: false,
        pastIllness: medHis.pastIllness,
        famIllness: medHis.famIllness,
        height: medHis.height,
        weight: medHis.weight,
        bloodType: medHis.bloodType,
        immunization: medHis.immunization,
        hospitalizations: medHis.hospitalizations,
        allergies: medHis.allergies,
        bodyArt: medHis.bodyArt,
        habits: medHis.habits,
        medication: medHis.medication,
        operations: medHis.operations,
        visualAcuity: medHis.visualAcuity,
        menarchYear: medHis.menarchYear,
        menarchAge: medHis.menarchAge,
        dysmennorrhea: medHis.dysmennorrhea,
        mensDuration: medHis.mensDuration
      });
    }
  }
  render() {
                ...
                <Fmedicalrecords
                  ...
                  records={this.state.records.map((record) => (
                    <main>
                      ...
                      <div class="divFooter">
                        Generated by: {this.state.firstName}{" "}
                        {this.state.middleName} {this.state.lastName}
                      </div>
...
export default connect(mapStateToProps, null)(Fprint);
